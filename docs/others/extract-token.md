...
打开 [Windsurf 官网](https://windsurf.com/) 的开发者控制台，在**登录后**抓取一个 `Fetch/XHR` 类型的包，在请求头中找到 `X-Devin-Session-Token` 或 `X-Auth-Token`

![](/4fbdec7a39fd42f80882456446a582a1.png)
...
![](/1da4f4d7646d2ecae141317cd36e6763.png)

2、自行抓包客户端接口获取 `Copilot`**专属**的 `github access_token`，在加号弹窗中批量添加

![](/f7abca7739be21bd8020ce7edf996c83.png)
