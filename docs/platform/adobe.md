...
| 参数取值                                                                          | 说明                         | 适用范围                                               |
| --------------------------------------------------------------------------------- | ---------------------------- | ------------------------------------------------------ |
| `720p`、`1080p`                                                                   | 生成视频的分辨率             | `veo-3-1`、`veo-3-1-fast`                              |
| `9:16`、`16:9`                                                                    | 生成视频的比例               | `veo-3-1`、`veo-3-1-fast`                              |
| `4s`、`6s`、`8s`                                                                  | 生成视频的时长               | `veo-3-1`、`veo-3-1-fast`                              |
| `fl`                                                                              | 是否生成首尾帧视频           | `veo-3-1`、`veo-3-1-fast`                              |
| `1K`、`2K`、`4K`                                                                  | 生成图片的分辨率             | `gpt-image-1.5`、`nano-banana` 除外                    |
| `8:1`、`4:1`                                                                      | `nano-banana-2` 专属图片比例 | `nano-banana-2`                                        |
| `2:3`、`1:1`、`3:2`                                                               | `gpt-image` 专属图片比例     | `gpt-image-1.5`、`gpt-image-2`                         |
| `21:9`、`16:9`、`5:4`、<br/>`4:3`、`3:2`、`1:1`、<br/>`4:5`、`3:4`、`2:3`、`9:16` | 生成图片比例                 | `nano-banana-2`、`nano-banana-pro`、<br/>`nano-banana` |
